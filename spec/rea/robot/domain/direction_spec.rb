  ...
  module Robot
    describe Direction do
      ...
      describe '#move' do
        ...
        let(:center_cell) { BoardCell.new(2,2) }
        let(:north_cell)  { BoardCell.new(2,3) }
        let(:east_cell)   { BoardCell.new(3,2) }
        let(:south_cell)  { BoardCell.new(2,1) }
        let(:west_cell)   { BoardCell.new(1,2) }
